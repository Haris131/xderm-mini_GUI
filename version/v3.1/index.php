    ...
    <form method="post">
		<center>
			<table align="center"><tr><td class="col-butt">
				...
				<input type="submit" name="button5" class="btn third" id="about"
					value="About"/>
...
echo '<center>
                                <input type="submit" name="button6" class="btn third" id="rmlogin"
                                        value="Remove / Install Login Page"/>

                                <input type="submit" name="button7" class="btn third"  id="reinstall"
...
echo '<input type="submit" name="simpan" class="btn third" width: 98%; height: 30px; margin-right: 20px; flex-shrink: 0; font-weight: bold; ! important;" value="Simpan"/></form></div>';
